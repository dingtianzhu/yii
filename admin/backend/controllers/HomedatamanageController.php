...
class HomedatamanageController extends \yii\web\Controller
{
    ...
    public function actionList()
    {
        ...
        $data = Homedatamanage::find()->where(["type"=>1]);
        $pages = new Pagination(['totalCount' =>$data->count(), 'pageSize' => '20']);
        $user = $data->joinWith('usergroup')->offset($pages->offset)->limit($pages->limit)->all();
    ...
    {
        $data = Homedatamanage::find()->where(["type"=>2]);
        $pages = new Pagination(['totalCount' =>$data->count(), 'pageSize' => '20']);
        $user = $data->joinWith('usergroup')->offset($pages->offset)->limit($pages->limit)->all();
    ...
    {
        $data = Homedatamanage::find()->where(["type"=>3]);
        $pages = new Pagination(['totalCount' =>$data->count(), 'pageSize' => '20']);
        $user = $data->joinWith('usergroup')->offset($pages->offset)->limit($pages->limit)->all();
    ...
    {
        $data = Homedatamanage::find()->where(["type"=>4]);
        $pages = new Pagination(['totalCount' =>$data->count(), 'pageSize' => '20']);
        $user = $data->joinWith('usergroup')->offset($pages->offset)->limit($pages->limit)->all();
		
        return $this->render('list4',[
            'user'=>$user,
            'pages' => $pages
        ]);
    }
